...
public:
    ...
    double hrate(const std::array<int, 3>& ijk, SourceComponent input ) const;
    double temperature(const std::array<int, 3>& ijk, SourceComponent input) const;
    // bool hasHrate(const std::array<int, 3>&, SourceComponent input) const;
    // bool hasTemperature(const std::array<int, 3>&, SourceComponent input) const;
